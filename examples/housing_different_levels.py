...
f.manual_forecast(how='simple',models=models,determine_best_by='ValidationMetricValue',call_me='avg') # simple average of top_3 models based on performance in validation
...
f.plot(models='all',order_by='LevelTestSetRMSE',print_attr=['LevelTestSetRMSE','LevelTestSetR2','LevelTestSetMAPE','HyperParams','Xvars','models']) # will automatically plot levels for everything
