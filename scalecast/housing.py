...
f.plot(models='top_5',order_by='LevelTestSetMAPE',print_attr=['TestSetRMSE','TestSetR2','TestSetMAPE','LevelTestSetRMSE','LevelTestSetR2','LevelTestSetMAPE','HyperParams','Xvars','models']) # plots the forecast differences or levels based on the level the forecast was performed on
f.plot(models='top_5',order_by='LevelTestSetMAPE',level=True) # plot the level forecast
